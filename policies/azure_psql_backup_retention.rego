...
controls := [
    # SAMA Cyber Security Framework v1.0
    {
        ...
        "control-link": "https://rulebook.sama.gov.sa/en/cyber-security-framework-2#backup-and-disaster-recovery"
    },
    # SAMA IT Governance Framework v1.0
    {
        ...
        "control-link": "https://rulebook.sama.gov.sa/en/it-governance-framework#backup-and-continuity"
    },
    # SAMA Risk Management Guidelines v1.0
    {
        ...
        "control-link": "https://www.sama.gov.sa/en/RulesInstructions/RiskManagement#backup-risk-management"
    },
]
